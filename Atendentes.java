...
import java.util.ArrayList;
 ...
 public class Atendentes implements Serializable{
     ...
     // Métodos
     public static Atendentes cadastrarAtendentes(Scanner input) {
     ...
     public static void atualizarAtendente(ArrayList<Atendentes> listaAtendentes, int ID, Scanner input) {
